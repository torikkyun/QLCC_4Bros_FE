...
export default function RoomDetail() {
  ...
  return (
    <View className="flex-1 bg-white px-4 pt-4">
      ...
      {/* Services */}
      <Text className="text-xl font-bold text-gray-700 mb-2">Thông tin phòng</Text>
      ...
      {/* Room Box */}
      <View className="bg-gray-100 rounded-xl justify-center items-center h-32 mb-6" style={{ height: '30%' }}>
        <Text className="text-7xl font-bold text-green-500">{room?.roomNumber || 'Not Found'}</Text>
      </View>
